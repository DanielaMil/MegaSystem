                ...
                <table class="mb-0 table table-bordered table-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Ciclo</font>
                                </font>
                            </th>
                            <th class="text-center">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;"># Matriculados</font>
                                </font>
                            </th>
                            ...
                            <th class="text-center">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;"># Retirados</font>
                                </font>
                            </th>
                        </tr>
                    </thead>
...
<script>
    ...
    function generarEXCEL() {
        ...
        for (let i = 0; i < arrayCiclo.length; i++) {
            ws_data.push([arrayCiclo[i], arrayMatriculados[i], arrayRetirados[i]])
        }
