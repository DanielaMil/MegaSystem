                                    ...
                                    <div class="row m-3 ">
                                        <div class="column m-3" style="width: 18em;">
                                            <div class="position-relative form-group">
                                                ...
                                                </label><input name="txtApellidoPa_Al" id="txtApellidoPaAl" type="text" class="form-control" pattern="[A-Za-z]+">
                                            </div>
                                        ...
                                        <div class="column m-3" style="width: 18em;">
                                            <div class="position-relative form-group"><label for="form-control" class="">
                                                ...
                                                </label><input name="txtApellidoMa_Al" id="txtApellidoMaAl" type="text" class="form-control" pattern="[A-Za-z]+">
                                            </div>
                                            <div class=" position-relative form-group">
                                        ...
                                        <div class="column m-3" style="width: 18em;">
                                            <div class="position-relative form-group">
                                                ...
                                                </label><input name="txtNombre_Al" id="txtNombreAl" type="text" class="form-control" pattern="[A-Za-z]+">
                                            </div>
                                            <div class="position-relative form-group">
                                                <label for="examplePassword" class="">
                                                    <font style="vertical-align: inherit;">
                                                ...
                                                <INPUT type="text" SIZE=9 id="txtCelularAl" class="form-control" style="width: 170px" pattern="[0-9]+">
                                            </div>
                                        </div>
                                    </div>
                                    <style>
                                        ...
                                        <div class="row m-3 ">
                                            <div class="column m-3" style="width: 17em;">
                                                <div class="position-relative form-group">
                                                    ...
                                                    </label><input name="txtApellidopa_Ap" id="txtApellidopa_Ap" type="text" class="form-control" pattern="[A-Za-z]+">
                                                </div>
                                                <div class=" position-relative form-group">
                                                    <label for="form-control" class="">
                                                        <font style="vertical-align: inherit;">
                                                    ...
                                                    </label><input name="txtParentesco_AP" id="txtParentesco_AP" type="text" class="form-control" pattern="[A-Za-z]+">
                                                </div>
                                                <div class=" position-relative form-group">
                                                    <label for="form-control" class="">
                                                        <font style="vertical-align: inherit;">
...
>>>>>>> d1624f82187e32f310e4039302c3cb248df88587
                                            ...
                                            <div class="column m-3" style="width: 17em;">
                                                <div class="position-relative form-group"><label for="form-control" class="">
                                                    ...
                                                    </label><input name="txtApellidoMa_AP" id="txtApellidoMa_AP" type="text" class="form-control" pattern="[A-Za-z]+">
                                                </div>
                                                <div class=" position-relative form-group"><label for="examplePassword" class="">
                                                        <font style="vertical-align: inherit;">
                                                            <font style="vertical-align: inherit;">celular</font>
                                                        </font>
                                                    </label><input name="txtCelular_AP" id="txtCelular_AP" type="text" class="form-control" style="width: 170px" pattern="[0-9]+">
                                                </div>
                                            </div>
                                            <div class="column m-3" style="width: 17em;">
                                                <div class="position-relative form-group">
                                                    ...
                                                    </label><input name="txtNombre_AP" id="txtNombre_AP" type="text" class="form-control" pattern="[A-Za-z]+">
                                                </div>
