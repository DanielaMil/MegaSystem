                                                    ...
                                                    <div class="row m-3 ">
                                                        <div class="column m-3 w-50">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                </label><input name="text" id="apMaterno" type="text" class="form-control" disabled="true"></div>
                                                            <div class="position-relative form-group">
                                                            ...
                                                            <div class="position-relative form-group">
                                                                ...
                                                                </label><input name="text" id="nombre" type="text" class="form-control" disabled="true"></div>
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <select name="select" id="exampleSelect" class="form-control" disabled="true">
                                                        ...
                                                        <div class="column m-3">
                                                            ...
                                                            <div class="position-relative form-group"><label for="examplePassword" class="">
                                                                ...
                                                                </label><input name="text" id="nombre" type="date" class="form-control" disabled="true"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row m-3">
                                                        <div class="column m-3 w-50">
                                                            ...
                                                            <div class="position-relative form-group"><label for="exampleSelect" class="">
                                                                ...
                                                                </label><select name="select" id="exampleSelect" class="form-control" disabled="true">
                                                                    <option>
                                                                    </option>
                                                                </select></div>
                                                        </div>
                                                    ...
                                                    <div class="row m-3 ">
                                                        ...
                                                        <div class="column m-3">
                                                            ...
                                                            <div class="position-relative form-group"><label for="exampleText" class="">
                                                                ...
                                                                </label><textarea name="text" id="exampleText" class="form-control" disabled="true"></textarea></div>
                                                        </div>
                                                    </div>
                                                    <button class="mt-1 btn btn-primary">
                                                        <font style="vertical-align: inherit;">
