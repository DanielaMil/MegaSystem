                                    ...
                                    <div class="card-body mx-auto style=width: 50px">
                                        <div class="form-inline">
                                            ...
                                            <div class="mb-2 mr-sm-2 mb-sm-0 form-group">
                                                ...
                                                <input name="txtDni_Al" id="txtDni_Al" type="text" class="form-control" pattern="[0-9]+" title="DNI incorrecto">
                                            </div> <button type="submit" class="btn btn-primary" id="btn_buscarAJAX_AL" style="width: 80px">Buscar</button>
                                    ...
                                    <div class="row m-3 ">
                                        <div class="column m-3" style="width: 18em;">
                                            <div class="position-relative form-group">
                                                ...
                                                </label><input name="txtApellidoPa_Al" id="txtApellidoPaAl" type="text" class="form-control" pattern="[A-Za-z]+" title="Apellido Paterno incorrecto">
                                            </div>
                                        ...
                                        <div class="column m-3" style="width: 18em;">
                                            <div class="position-relative form-group"><label for="form-control" class="">
                                                ...
                                                </label><input name="txtApellidoMa_Al" id="txtApellidoMaAl" type="text" class="form-control" pattern="[A-Za-z]+" title="Apellido Materno incorrecto">
                                            </div>
                                            <div class="position-relative form-group">
                                        ...
                                        <div class="column m-3" style="width: 18em;">
                                            <div class="position-relative form-group">
                                                ...
                                                </label><input name="txtNombre_Al" id="txtNombreAl" type="text" class="form-control" pattern="[A-Za-z]+" title="Nombre incorrecto">
                                            </div>
                                            <div class="position-relative form-group">
                                                <label for="examplePassword" class="">
                                                    <font style="vertical-align: inherit;">
                                                ...
                                                <INPUT type="text" SIZE=9 id="txtCelularAl" class="form-control" style="width: 170px" pattern="[0-9]+" title="Celular incorrecto">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body mx-auto style=width: 50px">
                                            <div class="form-inline">
                                                ...
                                                <div class="mb-2 mr-sm-2 mb-sm-0 form-group">
                                                    ...
                                                    <input name="txtDni_AP" id="txtDni_AP" type="text" class="form-control" pattern="[0-9]+" title="DNI incorrecto">
                                                </div>
                                        ...
                                        <div class="row m-3 ">
                                            <div class="column m-3" style="width: 17em;">
                                                <div class="position-relative form-group">
                                                    ...
                                                    </label><input name="txtApellidopa_Ap" id="txtApellidopa_Ap" type="text" class="form-control" pattern="[A-Za-z]+" title="Apellido Paterno incorrecto">
                                                </div>
                                                <div class="position-relative form-group">
                                                    <label for="form-control" class="">
                                                        <font style="vertical-align: inherit;">
                                                    ...
                                                    </label><input name="txtParentesco_AP" id="txtParentesco_AP" type="text" class="form-control" pattern="[A-Za-z]+" title="Parentesco incorrecto">
                                                </div>
                                                <div class="position-relative form-group">
                                                    <label for="form-control" class="">
                                                        <font style="vertical-align: inherit;">
                                            ...
                                            <div class="column m-3" style="width: 17em;">
                                                <div class="position-relative form-group"><label for="form-control" class="">
                                                    ...
                                                    </label><input name="txtApellidoMa_AP" id="txtApellidoMa_AP" type="text" class="form-control" pattern="[A-Za-z]+" title="Apellido Materno incorrecto">
                                                </div>
                                                <div class="position-relative form-group"><label for="examplePassword" class="">
                                                        <font style="vertical-align: inherit;">
                                                            <font style="vertical-align: inherit;">celular</font>
                                                        </font>
                                                    </label><input name="txtCelular_AP" id="txtCelular_AP" type="text" class="form-control" style="width: 170px" pattern="[0-9]+" title="Celular incorrecto">
                                                </div>
                                            </div>
                                            <div class="column m-3" style="width: 17em;">
                                                <div class="position-relative form-group">
                                                    ...
                                                    </label><input name="txtNombre_AP" id="txtNombre_AP" type="text" class="form-control" pattern="[A-Za-z]+" title="Nombre incorrecto">
                                                </div>
